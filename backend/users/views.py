...
from .serializers import SubscriptionUserSerializer, FoodgramUserSerializer
...
class FollowViewSet(GenericViewSet):
    ...
    def subscriptions(self, request, *args, **kwargs):
        ...
        if page is not None:
            serializer = SubscriptionUserSerializer(page, context={'request': request}, many=True)
            return self.get_paginated_response(serializer.data)
        serializer = SubscriptionUserSerializer(following, context={'request': request}, many=True)
